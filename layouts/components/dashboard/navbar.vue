      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="https://flowbite.com" class="flex ms-2 md:me-24">
            ...
            <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap">OnePointHub</span>
          </a>
        </div>
        <div class="flex items-center">
          <div class="flex items-center ms-3">
            ...
            <div
                v-show="showUser"
                v-on-click-outside="closeUser"
                class="absolute top-10 right-2.5 z-50 my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow"
            >
